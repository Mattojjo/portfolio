            ...
            <div className="pt-8">
              <div className="flex flex-wrap items-center gap-4">
                ...
                <div className="relative group">
                  <div className="w-12 h-12 bg-gray-100 rounded-xl neu-flat flex items-center justify-center animate-scale-wave-1">
                ...
                {/* React */}
                <div className="relative group">
                  <div className="w-12 h-12 bg-gray-100 rounded-xl neu-flat flex items-center justify-center animate-scale-wave-2">
                ...
                {/* Next.js */}
                <div className="relative group">
                  <div className="w-12 h-12 bg-gray-100 rounded-xl neu-flat flex items-center justify-center animate-scale-wave-3">
                    <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none">
                ...
                {/* Node.js */}
                <div className="relative group">
                  <div className="w-12 h-12 bg-gray-100 rounded-xl neu-flat flex items-center justify-center animate-scale-wave-4">
                ...
                {/* Spring Boot */}
                <div className="relative group">
                  <div className="w-12 h-12 bg-gray-100 rounded-xl neu-flat flex items-center justify-center animate-scale-wave-5">
                    <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none">
                ...
                {/* SQL/Database */}
                <div className="relative group">
                  <div className="w-12 h-12 bg-gray-100 rounded-xl neu-flat flex items-center justify-center animate-scale-wave-6">
                    <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none">
                ...
                {/* Tailwind CSS */}
                <div className="relative group">
                  <div className="w-12 h-12 bg-gray-100 rounded-xl neu-flat flex items-center justify-center animate-scale-wave-7">
                    <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none">
                ...
                {/* Vite */}
                <div className="relative group">
                  <div className="w-12 h-12 bg-gray-100 rounded-xl neu-flat flex items-center justify-center animate-scale-wave-8">
                    <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none">
                      <defs>
